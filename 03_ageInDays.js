...
function ageInDays(obj, callback){
    ...
    const ageDays = obj.ageInYears*365;
    callback(fullName,ageDays);
}

function consoleMsg(str,num){
    console.log(`The person's full name is ${str} and her age in days is ${num}.`)
}

ageInDays(person,consoleMsg);